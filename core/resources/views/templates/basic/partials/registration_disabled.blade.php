...
<div class="register-disable">
    <div class="container">
        ...
        <div class="text-center">
            <a class="btn btn--base" href="{{ @$registrationDisabled->data_values->button_url }}" class="register-disable-footer-link">{{ __(@$registrationDisabled->data_values->button_name) }}</a>
        </div>
    </div>
</div>
