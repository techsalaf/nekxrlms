                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <x-image-uploader image="{{ $course->image }}" class="w-100" type="course"
                                            :required=false />
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="premium" class="form-control select2"
                                                    ...
                                                    <option value="0" @selected(!$course->premium)>@lang('No')
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="any" min="0" class="form-control"
                                                        name="price" value="{{ getAmount($course->price) }}" required>
                                        ...
                                        <div class="col-md-6 priceArea">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="any" min="0" class="form-control"
                                                        name="discount_price"
                                                        value="{{ getAmount($course->discount_price) }}">
                                                    <span class="input-group-text">{{ __(gs('cur_text')) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="border rounded p-2">
                                        ...
                                        <div class="addedLearn mt-3">
                                            @foreach ($course->learns ?? [] as $learn)
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="learns[]"
                                                            value="{{ $learn }}" required>
                                                        <button class="btn btn--danger input-group-text deleteLearn"
                                                            type="button"><i class="las la-times m-0"></i></button>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control iconPicker icon"
                                                                    autocomplete="off" name="includes[icon][]"
                                                                    value="{{ $icon }}" required>
                                                                <span class="input-group-text  input-group-addon"
                                                                    data-icon="las la-home"
                                                                    role="iconpicker">@php echo $icon @endphp</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-7">
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control"
                                                                    name="includes[text][]"
                                                                    value="{{ $course->includes['text'][$loop->index] }}">
                                                                <button
                                                                    class="btn btn--danger input-group-text deleteInclude"
                                                                    type="button"><i
                                                                        class="las la-times m-0"></i></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
