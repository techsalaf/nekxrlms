...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(function(){
        ...
        Route::get('course-reviews', 'courseReviews')->name('course.reviews');
        Route::post('course-review/delete/{id}', 'deleteCourseReview')->name('course.review.delete');
    });
    ...
    Route::controller('CategoryController')->prefix('category')->name('category.')->group(function () {
        ...
        Route::post('toggle-show-on-banner/{id}', 'toggleShowOnBanner')->name('banner');
    });

    Route::controller('ManageCourseController')->prefix('course')->name('course.')->group(function () {
        ...
        Route::post('save/{id?}', 'save')->name('save');
        Route::post('status/{id}', 'status')->name('status');
        Route::get('course-page/video', 'coursePageVideo')->name('page.video');
        Route::post('course-page/video', 'saveCoursePageVideo')->name('page.video');

        Route::get('sections/{id}', 'sections')->name('section');
        Route::post('sections/save/{id?}', 'saveSection')->name('section.save');
        Route::get('section/lessons/{id}', 'lessonsBySection')->name('section.lessons');

        Route::get('lessons/{id}', 'lessons')->name('lessons');
        Route::post('lesson/save/{id?}', 'saveLesson')->name('lesson.save');
        Route::get('lesson/video/{id}', 'lessonVideo')->name('lesson.video');
        Route::post('lesson/video/{id}', 'uploadLessonVideo')->name('lesson.video.upload');
        Route::post('lesson/video/remote/{id}', 'remoteLessonVideo')->name('lesson.video.remote.server');
        Route::post('lesson/asset/{id}', 'uploadLessonAsset')->name('lesson.asset.upload');
        Route::post('lesson/status/{id}', 'lessonStatus')->name('lesson.status');
        Route::get('lesson/asset/download/{id}', 'downloadAsset')->name('lesson.asset.download');
    });
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function(){
        Route::get('purchase/history/{days?}', 'purchaseHistory')->name('purchase.history');
